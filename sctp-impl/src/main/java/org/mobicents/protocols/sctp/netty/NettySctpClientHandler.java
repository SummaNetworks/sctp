...
public class NettySctpClientHandler extends NettySctpChannelInboundHandlerAdapter {
    ...
    public void channelUnregistered(final ChannelHandlerContext ctx) throws Exception {
        ...
        if (this.association.getMainConnectionFuture() != null
                && this.association.getMainConnectionFuture().cause() != null
                && this.association.getMainConnectionFuture().cause() instanceof ConnectTimeoutException) {
